! function() {
    ...
    $(document).ready(function() {
        $('.left-side-nav [data-toggle="tooltip"]').tooltip({
            ...
            e.preventDefault(), $("body").toggleClass("left-side-toggled"), $(".left-side-nav .nav-link-collapse").addClass("collapsed"), $(".left-side-nav .sidenav-second-level, .left-side-nav .sidenav-third-level").removeClass("show")
        }), $("#sidenavToggler").on("click", function(e) {
            e.preventDefault(), $("body").toggleClass("sidenav-toggled"), $(".navbar-sidenav .nav-link-collapse").addClass("collapsed"), $(".navbar-sidenav .sidenav-second-level, .navbar-sidenav .sidenav-third-level").removeClass("show")
        }), $(".left-side-nav .nav-link-collapse").on("click", function(e) {
            e.preventDefault(), $("body").removeClass("left-side-toggled")
            ...
            return $(this).parent().next("dd"), $(this).parents(".accordion").find("dt > a").removeClass("active"), $(this).addClass("active"), $(this).parents(".accordion").find("dd").slideUp("easeInExpo"), $(this).parent().next().slideDown("easeOutExpo"), !1
        });
        $(".toggle > dd").hide();
